...
e2fielda=[0]*len(x)+1
gammafielda=[0]*len(x)
thetafielda=[0]*len(x)+1
fluxfielda=[0]*len(x)+1

xfieldb=[0]*len(x)+1
yfieldb=[0]*len(x)+1
e1fieldb=[0]*len(x)+1
e2fieldb=[0]*len(x)+1
gammafieldb=[0]*len(x)+1
thetafieldb=[0]*len(x)+1

xfieldc=[0]*len(x)+1
yfieldc=[0]*len(x)+1
e1fieldc=[0]*len(x)+1
e2fieldc=[0]*len(x)+1
gammafieldc=[0]*len(x)+1
thetafieldc=[0]*len(x)+1

xfieldd=[0]*len(x)+1
yfieldd=[0]*len(x)+1
e1fieldd=[0]*len(x)+1
e2fieldd=[0]*len(x)+1
gammafieldd=[0]*len(x)+1
thetafieldd=[0]*len(x)+1
